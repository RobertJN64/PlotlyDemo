...
class App:
    def __init__(self):
        ...
        tour = DashTour(steps=[{'selector': '[id="xaxis"]', 'content': "This controls the xaxis"},
                               {'selector': '[id="yaxis"]', 'content': "This controls the yaxis"},
                               {'selector': '[id="example-graph"]',
                                'content': "This autoupdates when the config changes."}],
                        isOpen=False,
                        id="tour_component",
                        children=html.Div(),
                        rounded=7
        ...
        self.app.callback(Output('tour_component', 'isOpen'), [Input('open_tour_button', 'n_clicks')],
                          prevent_initial_call=True)(self.openTourComponent)
